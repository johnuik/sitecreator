                  ...
                  {[
                    {
                      ...
                      bajaruvchi: ['Tojaliyev Shoxbozbek'],
                      start: '',
                      end: '2025-12-19',
                      ...
                      statuses: [
                        ...
                        { id: 9, label: "Yakunlangan", status: false },
                      ]
                    },
                    {
                      id: 2,
                    ...
                    <tr key={r.id} className="border-b align-middle py-6 hover:bg-gray-50 dark:hover:bg-[#2b2c40]">
                      ...
                      <td className="px-4 py-4 align-middle whitespace-pre-line text-[15px] text-[#8895a4] border-r">
                        {r.bajaruvchi.map((b, idx) => (
                          <span className='block mb-1' key={idx}>{b}</span>
                        ))}
                      </td>
                      ...
                      <td className="px-4 py-4 align-middle">
                        <div className="flex items-center gap-2">
                          <button className="p-2 rounded-md bg-sky-50 text-sky-400 font-bold" onClick={handlePdf}>
                            <iconify-icon icon="tabler:edit" width="20" height="20"></iconify-icon>
                          </button>
                          <button className="p-2 rounded-md bg-violet-50 text-violet-600" onClick={handleModal}>

...
const Card = ({ label, value, icon, accent = 'teal' }) => {
    ...
    return (
        <div className="bg-white dark:bg-[#2b2c40] bg-gradient-to-r from-cyan-600/10 to-bg-white stat-card" data-accent={accent}>
...
const DashboardPage = () => {
    ...
    const system = [
        ...
        { label: "Qisman yakunlangan:", value: 0, accent: 'aqua', icon: 'bx bxs-circle-quarter' },
        { label: 'Xat chiqarilgan:', value: 0, accent: 'muted', icon: 'bx bxs-circle-quarter' },
        { label: 'Xat kelgan:', value: 0, accent: 'muted', icon: 'bx bxs-circle-quarter' },
        { label: 'Jarayonda:', value: 0, accent: 'aqua', icon: 'bx bxs-circle-half' },
        { label: "O'tib ketgan:", value: 0, accent: 'red', icon: 'bx bxs-circle-half' },
        { label: 'Hisobotga chiqarilgan:', value: 0, accent: 'blue', icon: 'bx bxs-circle-three-quarter' },
    ...
    return (
        <div className="dashboard-page dark:bg-[#1e1e2f] " style={{ margin: '-20px' }}>

            <div className="mt-4 text-xl text-gray-400 font-medium mb-4 "> Bosh sahifa / <span className='text-gray-600'>Tizim ekspertizalar</span></div>

            <Section title="Tizim ekspertizalar" items={system} />

            <div className="mt-8 text-xl text-gray-400 font-medium mb-4 "> Bosh sahifa / <span className='text-gray-600'>Mobil ekspertizalar</span></div>

            <Section title="Mobil ekspertizalar" items={mobile} />

            <div className="mt-10 text-xl text-gray-400 font-medium mb-2 "> Bosh sahifa / <span className='text-gray-600'>Kunlik topshiriqlar</span></div>
            ...
            <div className="mt-10 text-xl text-gray-400 font-medium mb-2 "> Bosh sahifa / <span className='text-gray-600'>Summa</span></div>
            ...
            <div className="mt-4">
                <div className="lt-sum dark:bg-[#2b2c40] bg-gradient-to-r from-cyan-600/10 to-bg-white border border-gray-200 dark:border-neutral-600">
                    <div className="lt-sum__dot w-6 h-6" style={{ background: 'var(--accent-purple)' }}></div>

...
const Word = () => {
  ...
  useEffect(() => {
    ...
    strongElements.forEach(el => {
      ...
      else if (text === "Ekspluatatsiya oqibatlari" || text === "Tavsiyalar") {
        if (!el.closest("td")) {
  ...
  `}
        >
          <iconify-icon icon="pepicons-print:printer" width="1.2em" height="1.2em" ></iconify-icon>
          <span> Hisobot </span>
        </button>

        <div className="edit-btn-global" onClick={() => setEditing(!editing)}>
          {editing ? (<div className="cursor-pointer change-btn">
      ...
      <div className="a4 first-a4">
        <div className="page-content">
          <h2 className="application-name">“Abm Mobil”</h2>
        </div>
      </div>
      <div className="a4 mundarija1">
        <div className="page-content top editable">
          ...
          <div className="mundarija-content first">
            ...
            <div className="mundarija-section">
              birinchi bo‘lim.
            </div>
            <div className="mundarija-head">
              UMUMIY MA’LUMOTLAR
            </div>
            <div className="mundarija-body">
              ...
              <div className="mundarija-row">
                <div className="row-title">Ekspertiza o‘tkazish
                  uchun asos</div>
          ...
          <div className="mundarija-content">
            ...
            <div className="mundarija-body">
              <div className="mundarija-row">
                <div className="row-title large">Ekspertiza natijalari to‘g‘risida umumlashtirilgan <br />ma’lumot</div>
                <div className="row-num">14</div>
              </div>
              <div className="mundarija-row">
                <div className="row-title large">Android mobil ilovasi ekspertizasi natijalari bo‘yicha batafsil izoh</div>
                <div className="row-num">
                  16
                </div>
              </div>
              <div className="mundarija-row">
                <div className="row-title large">Ilova ma’lumotlarining zaxira nusxasini yaratish</div>
                <div className="row-num">
                  16
                </div>
              </div>
      ...
      <div className="a4 mundarija2">
        <div className="page-content editable">
          ...
          <div className="mundarija-content">
            <div className="mundarija-body">
              <div className="mundarija-row">
                <div className="row-title large">SQL buyruqlarini
                  to‘g‘ridan-to‘g‘ri bajarilishi </div>
                <div className="row-num">18</div>
              </div>
              <div className="mundarija-row">
                <div className="row-title large">Zaif shifrlash algoritmlari </div>
                <div className="row-num">
                  20
                </div>
              </div>
      ...
      <div className="a4">
        ...
        <div className="page-content editable">
          ...
          <div className="text">"Kiberxavfsizlik markazi" davlat unitar korxonasi va "AXBOROTLASHTIRISH BOSH
            MARKAZI" MCHJ oʻrtasida tuzilgan 2025-yil 17 noyabrdagi <b className="text-b">"ABM mobile"</b> mobil
            ilovasini kiberxavfsizlik talablariga muvofiqligi yuzasidan ekspertizadan oʻtkazish
            to'g'risidagi <b className="text-b">"1016-M"</b> shartnoma.</div>

          <div className="title">
            1.3. Ekspertiza obyekti
          </div>
          <div className="text">
            <b>“ABM mobile” android/iOS </b> mobil ilovasining <b>“app-release.apk”</b> va <b>“Cbu.Mobile.ipa”</b> fayllari.
          </div>
          ...
          <table className="expert-table">
            <thead>
              <tr>
                ...
                <th style={{ width: "200px", minWidth: "200px" }}>Texnik ma’lumot nomlanishi</th>
          ...
          <table className="expert-table mt-6">
            <tbody>
              ...
              <tr>
                <td>16.</td>
                <td>SHA256</td>
                <td>crc64779ff7dbaba30e1392ad83157fbd8174df3f1439ab3075cbfdfgdsgd</td>
              </tr>
            </tbody>
          </table>
      ...
      <div className="a4" style={{
        ...
        <div className="page-content editable">
          ...
          <div className="text">
            Ekspertiza o‘tkazish tartibi asosida amalga
            oshiriladigan ishlar jarayoni quyidagi tadbirlarni ham o‘z
            ichiga oladi:
          </div>
        </div>
        <div className="page-number flex justify-center mt-auto">
      ...
      <div className="a4" style={{
        ...
        <div className="page-content editable">
          ...
          <div className="title">1.5. Ekspertiza yuzasidan qo‘shimcha
            ma’lumotlar</div>
          <div className="text">
            “MONIX” android/iOS mobil ilovalari ekspertizasi
            buyurtmachi tomonidan taqdim qilingan
            ma’lumotlar, jumladan: <br />
            <b>- “base.apk”;</b>  <br />
      ...
      <div className="a4" style={{
        ...
        <div className="page-content editable">
          ...
          <div className="title">
            2.1. Ekspertiza natijalari to‘g‘risida
            umumlashtirilgan ma’lumot
          </div>
          <div className="text">
            Ekspertiza natijalari asosida 3 xil xavflilik darajasiga
            ega, ya’ni <b>yuqori, o‘rta</b> va <b>past</b> xavflilik darajasidagi
            axborot xavfsizligi zaifliklari va tizimda ma’lumot uchun
            holatlar aniqlanishi mumkin.
          </div>
          <div className="text">
            Axborot xavfsizligi zaifliklari xavflilik darjasidan kelib
            chiqqan holda mobil ilovaga quyidagi risklar xavf
            soladi.
          </div>
          <div className="text">
            <b>Yuqori</b> - ushbu turdagi axborot xavfsizligi zaifliklari
            ilovaga eng yuqori xavf ko‘rsatadi. Ulardan
            foydalanish ilovaga ruxsatsiz kirish, uning
            ma’lumotlaridan foydalanish bilan bir qatorda muhim,
            konfidensial ma’lumotlarni sizib chiqish holatlarini
            yuzaga kelishiga sabab bo‘lishi mumkin.
          </div>
          <div className="text">
            <b>O‘rta</b> - ushbu turdagi axborot xavfsizligi zaifliklari
            ko‘p holatlarda boshqa turdagi xavflilik darajasi yuqori
            bo‘lgan harakatlarni amalga oshirishga, ilova bilan
            bog‘liq ma’lumotlarni to‘plashga xizmat qiladi.
          </div>
          <div className="text">
            <b>Past</b> - ushbu turdagi axborot xavfsizligi zaifliklari
            ilovada umumiy ma’lumotlarga ega bo‘lish
            imkoniyatini taqdim etadi.
          </div>
          <div className="text">
            <b>Ma’lumot uchun </b> – ilovaga xavf solmaydigan,
            ekspertiza davrida aniqlangan axborot xavfsizligiga zid
            holatlar.
          </div>
        </div>
        <div className="page-number flex justify-center mt-auto">
      ...
      <div className="a4" style={{
        ...
        <div className="page-content editable">
          <div className="text">
            Olib borilgan ekspertiza natijalari asosida
            aniqlangan axborot xavfsizligi zaifliklari to‘g‘risida
            umumlashtirilgan ma’lumotlar 5-jadvalda taqdim
            qilingan.
          </div>
          ...
          <table class="expert-table">
            <thead>
              <tr>
                <th style={{ width: "200px", minWidth: "200px" }}>Xavflilik
                  darajasi </th>
                <th style={{ width: "300px", minWidth: "300px" }} colSpan={2}>Aniqlangan zaifliklar nomi va soni</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td><b>Yuqori</b></td>
                <td style={{ fontWeight: "normal" }}>Ilovada o‘zining yaxlitligini
                  tekshirish mexanizmi joriy
                  etilmaganligi</td>
                <td>1</td>
              </tr>
            </tbody>
      ...
      <div className="a4" style={{
        ...
        <div className="page-content editable">
          <div className="title">
            2.2. Android mobil ilovasi ekspertizasi natijalari
            bo‘yicha batafsil izoh
          </div>
          <div className="exp-title">
            2.2.1. Ilovada o‘zining yaxlitligini tekshirish
            mexanizmi joriy etilmaganligi
          </div>
          <div className="exp-d">
            <b className="underline">Xavflilik darajasi: </b> Yuqori.
          </div>
          <div className="text">
            Ilova o‘z kodlari va imzo ma’lumotlarining yaxlitligini
            va haqiqiyligini tekshirmaydi. Bunday holatda ilova
            qayta yig‘ilgan, statik modifikatsiyaga uchragan yoki
            noto‘g‘ri/soxta sertifikat bilan imzolangan bo‘lsa,
            server yoki ilova buni aniqlay olmaydi. Mazkur turdagi
            zaiflik  <b>“MASWE-0104”</b> (inglizcha. <b>App Integrity Not
              Verified </b> – Ilova yaxlitligi tasdiqlanmasligi) identifikator
            raqamiga ega kategoriyaga mansub.
          </div>
      ...
      <div className="a4" style={{
        ...
        <div className="page-content editable">
          <div className="text mb-[-10px]"><b>Ekspluatatsiya oqibatlari
          </b></div>
          <div className="text">Ilovani kodiga o‘zgartirish kiritish va uni qayta yig‘ish,
            zararli kod qo‘shish yoki imzoni almashtirib,
            foydalanuvchilarga zarar yetkazuvchi soxta talqinlarni
            tarqatish holatlariga olib kelishi mumkin. </div>
          <div className="text"><b>Tavsiya
          </b></div>
          <div className="text">
            Ilova ishga tushganida o‘zining imzosini, to‘liqligini
            tekshirish mexanizmini quyi darajadagi (Native C++)
            dasturlash tillaridan foydalangan holda joriy etish.
          </div>
        </div>
        <div className="page-number flex justify-center mt-auto">
          <span>17</span>
